...
#SBATCH --job-name=gsc_train_nogate50
...
CMD=(python -u run_training.py data_dir="${GSC_DIR}" \
  ...
  +model.ssm.input_gate=false +model.ssm.input_gate_rank=0 +model.ssm.input_gate_mode=sigmoid +model.ssm.input_gate_min=0.0 \
